...
export const serviceData = [
  {
    ...
    shortDescription:
      'Crafting dynamic, high-performance web applications with JavaScript to captivate users.',
  },
  {
    icon: ReactIcon,
    title: 'React.js Development',
    shortDescription:
      'Building sleek, responsive, and intuitive user interfaces with React.js for seamless experiences.',
  },
  {
    icon: NodejsIcon,
    title: 'Node.js Backend',
    shortDescription:
      'Developing fast, scalable server-side solutions with Node.js to power your applications.',
  },
  {
    icon: NextjsIcon,
    title: 'Next.js Development',
    shortDescription:
      'Creating optimized, server-rendered React apps with Next.js for superior performance.',
  },
  {
    icon: TypescriptIcon,
    title: 'TypeScript Development',
    shortDescription:
      'Delivering robust, type-safe code with TypeScript for maintainable, error-free applications.',
  },
  {
    icon: TailwindCSS,
    title: 'Tailwind CSS Styling',
    shortDescription:
      'Designing stunning, responsive interfaces with Tailwind CSS for a polished look.',
  },
  {
    icon: MongoDBIcon,
    title: 'MongoDB Database Solutions',
    shortDescription:
      'Building efficient, scalable databases with MongoDB for seamless data management.',
  },
  {
    icon: ExpressIcon,
    title: 'Express.js Backend',
    shortDescription:
      'Creating streamlined, robust APIs with Express.js to fuel your app’s backend.',
  },
  {
    icon: ReduxIcon,
    title: 'Redux State Management',
    shortDescription:
      'Implementing predictable, scalable state management with Redux for complex applications.',
  },
]
...
export const themes = [
  ...
  {
    name: 'Dark',
    colors: ['#0b0f19', '#94a3b8', '#1e293b', '#38bdf8', '#22d3ee'],
    // bg-dark, text-muted, panel-dark, accent-blue, neon-cyan
  },
  {
    name: 'Aqua',
